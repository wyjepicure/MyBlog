...
- 前端代码生成的文件文件路径请在Blog.Application类库中生成的对应实体代码文件中的Client中。
...
如果你选择了**生成权限功能**，请打开Blog.Application类库中的BlogApplicationModule.cs类文件。
...
请打开Blog.Application类库中BlogApplicationModule.cs中的 PreInitialize 方法中:
...
生成的多语言内容
在Blog.Core类库中对应实体下的`douyuyan.md`文件中。
